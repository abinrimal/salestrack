...
class CBSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Cms_modulsSeeder::class,
        Cms_privilegesSeeder::class,
        Cms_privileges_rolesSeeder::class,
        Cms_settingsSeeder::class,
        CmsEmailTemplates::class]);
